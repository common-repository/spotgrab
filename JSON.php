...
class spotgrab_Moxiecode_JSONReader {
	var $_data, $_len, $_pos;
	var $_value, $_token;
	var $_location, $_lastLocations;
	var $_needProp;

	function spotgrab_Moxiecode_JSONReader($data) {
		$this->_data = $data;
 ...
 */
class spotgrab_Moxiecode_JSON {
	function spotgrab_Moxiecode_JSON() {
	}

	function decode($input) {
		$reader = new spotgrab_Moxiecode_JSONReader($input);
